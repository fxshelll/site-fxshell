...
```sh
Sou DevOps/SRE formado em Defesa Cibernética, com mais de 10 anos de experiência  
em infraestrutura, automação e ambientes em nuvem.
...
(EKS e AKS), e mantendo pipelines CI/CD com GitHub Actions e GitOps via ArgoCD.
...
Busco sempre entregar soluções que sejam seguras, escaláveis e inteligentes —  
sem enrolação e com foco no que resolve.
```
![HTB](/cafeSobre2.png)
